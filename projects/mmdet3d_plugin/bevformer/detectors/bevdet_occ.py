...
class BEVDetOcc(MVXTwoStageDetector):
    ...
    def forward_test(self,
        ...
        if not isinstance(img[0][0], list):
            ...
            if DEBUG:
                ...
                print()
                save_root = '/home/txy/bev_nus_test/'
