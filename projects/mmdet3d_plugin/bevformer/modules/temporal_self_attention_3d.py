...
class TemporalSelfAttention3D(BaseModule):
    ...
    def forward(self,
        ...
        output = multi_scale_deformable_attn_pytorch_3d(value, spatial_shapes, sampling_locations, attention_weights)
...
def multi_scale_deformable_attn_pytorch_3d(value, value_spatial_shapes,
