...
class VolFormerEncoder(TransformerLayerSequence):
    ...
    def __init__(self, *args, pc_range=None, num_points_in_pillar=4, num_points_in_voxel=1,
        ...
        super(VolFormerEncoder, self).__init__(*args, **kwargs)
...
class VolFormerLayer(MyCustomBaseTransformerLayer):
    ...
    def __init__(self,
                 ...
                 ffn_num_fcs=2,
                 **kwargs):
        super(VolFormerLayer, self).__init__(
            attn_cfgs=attn_cfgs,
