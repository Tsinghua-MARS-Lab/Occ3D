...
class HybridOccFormerHead(BaseModule):
    """Head of Detr3D.
    Args:
    ...
    def __init__(self,
        ...
        super(HybridOccFormerHead, self).__init__()
        if self.more_conv:
    ...
    def forward(self, mlvl_feats, img_metas, prev_bev=None, only_bev=False, test=False):
        ...
        voxel_embed = outputs[-1].permute(0, 2, 1).view(bs, -1,self.bev_z, self.bev_h, self.bev_w)
